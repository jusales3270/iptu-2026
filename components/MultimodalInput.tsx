...
function PureSuggestedActions({
  ...
  const suggestedActions = [
    {
      title: 'Por que meu IPTU',
      label: 'subiu tanto em 2026?',
      action: 'Por que meu IPTU subiu tanto em 2026?',
    },
    {
      title: 'Como calcular',
      label: 'o valor do meu terreno?',
      action: 'Como calcular o valor do meu terreno?',
    },
    {
      title: 'O que é UFM',
      label: 'e qual o valor atual?',
      action: 'O que é UFM e qual o valor atual?',
    },
    {
      title: 'Ver tabela de valores',
      label: 'por bairro de Boituva',
      action: 'Quais são os valores estimados por bairro?',
    },
  ];
...
const PreviewAttachment: React.FC<{
  ...
  return (
    <div className={cn("relative w-full flex flex-col gap-4", className)}>
      ...
      <Textarea
        ...
        ref={textareaRef}
        placeholder="Digite sua dúvida sobre o IPTU..."
        value={input}
